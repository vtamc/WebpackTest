...
__WEBPACK_IMPORTED_MODULE_0_jquery___default()(() => {
	...
	let map = new __WEBPACK_IMPORTED_MODULE_1_openlayers___default.a.Map({
		layers: [
			new __WEBPACK_IMPORTED_MODULE_1_openlayers___default.a.layer.Tile({
				source: new __WEBPACK_IMPORTED_MODULE_1_openlayers___default.a.source.OSM()
			})
		],
		target: 'map',
		view: new __WEBPACK_IMPORTED_MODULE_1_openlayers___default.a.View({
			center: [0, 0],
			zoom: 2
		})
	});
